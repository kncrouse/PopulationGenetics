...
to-report get-color
  ...
  let dominance get-allele-dominance
  if dominance = "recessive-dominant" [ set report-color [color] of second-allele ]
  if dominance = "dominant-recessive" [ set report-color [color] of first-allele ]
  if dominance = "identical" [ set report-color [color] of first-allele ]
  if dominance = "codominant" [ set report-color (word [color] of first-allele "-" [color] of second-allele) ]
  report report-color
end
