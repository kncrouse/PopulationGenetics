...
"" ""
PENS
"red" 1.0 0 -2674135 true "" ";set-plot-pen-color read-from-string allele-one-color plot 100 * (count alleles with [ allele-type = \"one\" ] / (count alleles + 1))"
"blue" 1.0 0 -13345367 true "" ";set-plot-pen-color read-from-string allele-two-color plot 100 * (count alleles with [ allele-type = \"two\" ] / (count alleles + 1))"
"yellow" 1.0 0 -1184463 true "" ";set-plot-pen-color read-from-string allele-three-color plot 100 * (count alleles with [ allele-type = \"three\" ] / (count alleles + 1))"
...
@#$#@#$#@
Version 20190919 - Compatible with NetLogo 6.1.0
