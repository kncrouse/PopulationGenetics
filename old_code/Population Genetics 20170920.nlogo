...
to setup-parameters
  ...
  set population-radius sqrt ( population-size )
...
50
reproduce
set generation-number generation-number + 1\nask students [ execute-reproduce ]\nask students [ foreach n-of (length phenotype-population - population-size) phenotype-population [ ask ? [remove-phenotype] ]]\nupdate-allele-frequency-plot
NIL
1
T
OBSERVER
