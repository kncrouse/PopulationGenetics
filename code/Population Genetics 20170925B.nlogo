...
to send-info-to-clients
  ...
  hubnet-send user-id "phenotype one-one" get-color "one" "one"
  hubnet-send user-id "phenotype one-two" get-color "one" "two"
  hubnet-send user-id "phenotype one-three" get-color "one" "three"
  hubnet-send user-id "phenotype one-four" get-color "one" "four"
  hubnet-send user-id "phenotype two-two" get-color "two" "two"
  hubnet-send user-id "phenotype two-three" get-color "two" "three"
  hubnet-send user-id "phenotype two-four" get-color "two" "four"
  hubnet-send user-id "phenotype three-three" get-color "three" "three"
  hubnet-send user-id "phenotype three-four" get-color "three" "four"
  hubnet-send user-id "phenotype four-four" get-color "four" "four"
end
